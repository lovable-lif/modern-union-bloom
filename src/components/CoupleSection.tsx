    ...
    <section className="py-20 px-6 bg-white" id="couple">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <div className="h-px bg-gradient-to-r from-transparent via-sage-300 to-transparent w-24 mx-auto"></div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <div className="text-center animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <div className="mb-8">
              <div className="w-48 h-48 md:w-64 md:h-64 mx-auto bg-gradient-to-br from-sage-100 to-sage-200 rounded-full flex items-center justify-center mb-6 shadow-lg">
