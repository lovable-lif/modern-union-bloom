...
const Footer = () => {
  ...
  return (
    <footer className="py-16 px-6 bg-sage-700 text-white">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="animate-fade-in-up border-t border-sage-600 pt-8 mb-8" style={{ animationDelay: '0.3s' }}>
          <div className="grid md:grid-cols-3 gap-6 text-center">
            <div>
              ...
              <p className="text-sage-300 font-sans">August 7, 2025</p>
            </div>
            <div>
              <h3 className="font-serif text-lg text-cream-100 mb-2">Time</h3>
              <p className="text-sage-300 font-sans">8:00 AM - 6:00 PM</p>
            </div>
            <div>
        ...
        {/* Thank you message */}
        <div className="animate-fade-in-up bg-sage-600 rounded-2xl p-6 mb-8" style={{ animationDelay: '0.5s' }}>
          <div className="text-sage-200 text-2xl mb-4">🤲</div>
        ...
        {/* Social sharing */}
        <div className="animate-fade-in-up border-t border-sage-600 pt-8" style={{ animationDelay: '0.7s' }}>
          <div className="mb-6">
